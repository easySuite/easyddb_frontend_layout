...
<div <?php if (!empty($css_id)) { print ' id="$css_id"'; } ?> class="frontpage-layout limit-width">
  ...
  <?php if ($content['s1_r_07_033_1'] || $content['s1_r_07_033_2'] || $content['s1_r_07_033_3']): ?>
  <div class="col12 panel-pane clearfloat">
 ...
 <?php endif; ?>
  <?php if ($content['s1_r_08_050'] || $content['s1_r_08_025_1'] || $content['s1_r_08_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
 ...
 <?php endif; ?>
  <?php if ($content['s1_r_09_025_1'] || $content['s1_r_09_050'] || $content['s1_r_09_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
 ...
 <?php endif; ?>
  <?php if ($content['s1_r_10_025_1'] || $content['s1_r_10_025_2'] || $content['s1_r_10_050']): ?>
  <div class="col12 panel-pane clearfloat">
 ...
 <?php endif; ?>
  ...
  <?php if ($content['s1_r_11_025_1'] || $content['s1_r_11_025_2'] || $content['s1_r_11_025_3'] || $content['s1_r_11_025_4']): ?>
  <div class="col12 panel-pane clearfloat">
 ...
 <?php endif; ?>
  ...
  <div class="layout-wrapper">
    ...
    <?php endif; ?>
    <?php if ($content['s2_r_08_050'] || $content['s2_r_08_025_1'] || $content['s2_r_08_025_2']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s2_r_09_025_1'] || $content['s2_r_09_050'] || $content['s2_r_09_025_2']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s2_r_10_025_1'] || $content['s2_r_10_025_2'] || $content['s2_r_10_050']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s2_r_11_025_1'] || $content['s2_r_11_025_2'] || $content['s2_r_11_025_3'] || $content['s2_r_11_025_4']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php if ($content['s3_r_07_033_1'] || $content['s3_r_07_033_2'] || $content['s3_r_07_033_3']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s3_r_08_050'] || $content['s3_r_08_025_1'] || $content['s3_r_08_025_2']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s3_r_09_025_1'] || $content['s3_r_09_050'] || $content['s3_r_09_025_2']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s3_r_10_025_1'] || $content['s3_r_10_025_2'] || $content['s3_r_10_050']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php if ($content['s3_r_11_025_1'] || $content['s3_r_11_025_2'] || $content['s3_r_11_025_3'] || $content['s3_r_11_025_4']): ?>
    <div class="col12 panel-pane clearfloat">
  ...
  <?php if ($content['s4_r_07_033_1'] || $content['s4_r_07_033_2'] || $content['s4_r_07_033_3']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s4_r_08_050'] || $content['s4_r_08_025_1'] || $content['s4_r_08_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s4_r_09_025_1'] || $content['s4_r_09_050'] || $content['s4_r_09_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s4_r_10_025_1'] || $content['s4_r_10_025_2'] || $content['s4_r_10_050']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php if ($content['s4_r_11_025_1'] || $content['s4_r_11_025_2'] || $content['s4_r_11_025_3'] || $content['s4_r_11_025_4']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <div class="layout-wrapper">
    ...
    <?php endif; ?>
    <?php if ($content['s5_r_08_050'] || $content['s5_r_08_025_1'] || $content['s5_r_08_025_2']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s5_r_10_025_1'] || $content['s5_r_10_025_2'] || $content['s5_r_10_050']): ?>
    <div class="col12 panel-pane clearfloat">
    ...
    <?php endif; ?>
    <?php if ($content['s5_r_11_025_1'] || $content['s5_r_11_025_2'] || $content['s5_r_11_025_3'] || $content['s5_r_11_025_4']): ?>
    <div class="col12 panel-pane clearfloat">
  ...
  <?php if ($content['s6_r_07_033_1'] || $content['s6_r_07_033_2'] || $content['s6_r_07_033_3']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s6_r_08_050'] || $content['s6_r_08_025_1'] || $content['s6_r_08_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s6_r_09_025_1'] || $content['s6_r_09_050'] || $content['s6_r_09_025_2']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php endif; ?>
  <?php if ($content['s6_r_10_025_1'] || $content['s6_r_10_025_2'] || $content['s6_r_10_050']): ?>
  <div class="col12 panel-pane clearfloat">
  ...
  <?php if ($content['s6_r_11_025_1'] || $content['s6_r_11_025_2'] || $content['s6_r_11_025_3'] || $content['s6_r_11_025_4']): ?>
  <div class="col12 panel-pane clearfloat">
